    ...
    <div className="def-modal-overlay" onClick={onClose}>
      <div className="def-modal-container" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="def-modal-body">
          ...
          {/* Part 2 — Upload (Deferment) or View uploaded file (Deferment Replied) */}
          <div className="def-section">
            {isDefermentReplied ? (
              <>
                <h3 className="def-section-title">
                ...
                {uploadedFile ? (
                  <div className="def-uploaded-file">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                      ...
                      <path d="M14 2v6h6" stroke="#6366f1" strokeWidth="2" strokeLinecap="round"/>
                    </svg>
                    <span className="def-uploaded-name">{uploadedFile.name}</span>
                    <a href={uploadedFileUrl} download={uploadedFile.name} className="def-download-link">
                      Download
                    </a>
                  </div>
                ) : (
                  <p className="def-no-file">No reply file attached.</p>
                )}
              </>
            ) : (
              <>
