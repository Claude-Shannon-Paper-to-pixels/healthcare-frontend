...
function AddOnProceduresDetails({ procedures = [], loading = false, error = '', canManageClinical = false, onStatusChange }) {
  ...
  if (loading) return <div className="loading">Loading add-on procedures...</div>;
  if (error)   return <div className="error-message">{error}</div>;
  if (!procedures.length) return <div className="empty-state">No add-on procedures available.</div>;
          ...
          <div key={procedure.id} className="detail-group">
            ...
            <div className="detail-grid">
              ...
              <div className="detail-item">
                ...
                <span className="detail-value">{procedure?.estimated_cost ?? 'N/A'}</span>
              </div>
              <div className="detail-item">
