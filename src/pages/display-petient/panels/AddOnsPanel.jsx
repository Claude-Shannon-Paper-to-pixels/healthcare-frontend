...
function AddOnsPanel({ addOnProcedures, addOnLoading, addOnError, canManageClinical, showCreateAddOn, setShowCreateAddOn, handleCreateAddOnProcedure, savingSection, patientId, addOnEmailStatus, onStatusChange }) {
  return (
    <DetailSection title="Add-on Procedures" subtitle="Procedures linked to this patient" isEditing={false} onEdit={() => {}} showEdit={false}>
      ...
      <AddOnProceduresDetails procedures={addOnProcedures} loading={addOnLoading} error={addOnError} canManageClinical={canManageClinical} onStatusChange={onStatusChange} />
    </DetailSection>
  );
}
